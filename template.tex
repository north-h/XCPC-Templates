...
\subsection{线段树（朴素）}
\lstinputlisting{数据结构/线段树（朴素）.cpp}
\subsection{线段树 （lazy）}
\lstinputlisting{数据结构/线段树 （lazy）.cpp}
\subsection{ST表}
...
\section{字符串}
\subsection{单哈希}
\lstinputlisting{字符串/单哈希.cpp}
\subsection{双哈希}
\lstinputlisting{字符串/双哈希.cpp}
\subsection{自然溢出}
\lstinputlisting{字符串/自然溢出.cpp}
\subsection{字典树}
\lstinputlisting{字符串/字典树.cpp}
\subsection{马拉车}
\lstinputlisting{字符串/马拉车.cpp}
\subsection{正反哈希}
\lstinputlisting{字符串/正反哈希.cpp}
\section{杂项}
\subsection{快读快写}
